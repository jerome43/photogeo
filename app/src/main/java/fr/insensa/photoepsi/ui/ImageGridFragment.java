...
public class ImageGridFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            return uri_pictureArray.size() + mNumColumns;
        }

        @Override
        public Object getItem(int position) {
            return position < mNumColumns ?
                    null : uri_pictureArray.get(position - mNumColumns);
        }
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (position < mNumColumns) {
               ...
               //         LayoutParams.MATCH_PARENT, mActionBarHeight));
                // désactivé car l'actionBar a été remise
                convertView.setLayoutParams(new AbsListView.LayoutParams(
                        LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
                return convertView;
            }
           ...
           // mImageFetcher.loadImage(Images.imageThumbUrls[position - mNumColumns], imageView);
            mImageFetcher.loadImage(uri_pictureArray.get(position - mNumColumns), imageView);
            return imageView;
    ...
    // pour récupérer uri des images à afficher dans la grille
